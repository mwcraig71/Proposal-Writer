...
- **Template Management:** Settings page provides export/import/reset for five template types: SF330 Section F, Company Project, Resume, SF330 Section E Resume, and SF330 Section G Matrix. All use the same `{{PLACEHOLDER_NAME}}` syntax. Templates stored in Replit Object Storage. Section G template dynamically expands rows to fit any number of personnel.
