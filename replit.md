...
- **Template Management:** Settings page provides export/import/reset for four template types: SF330 Section F, Company Project, Resume, and SF330 Section E Resume. All use the same `{{PLACEHOLDER_NAME}}` syntax. Templates stored in Replit Object Storage.
