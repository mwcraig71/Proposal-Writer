...
- **Organizational Chart Builder:** An interactive React/Vite application for dynamically creating and assigning roles, with drag-and-drop, various export options (PDF, JPG, SmartDraw CSV), and customizable visual settings.
...
- **AI Writing Preferences:** Global settings for Writing Style, Writing Tone, Banned Words/Phrases, Acronyms, and Industry Words/Phrases, injected into all AI prompts.
